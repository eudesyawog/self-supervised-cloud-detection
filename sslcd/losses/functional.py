...
def multi_soft_dice_loss_with_logits(
    y_pred: TensorType,
    y_true: TensorType,
    smooth: float = 1e-7,
    reduction: str = "mean",
    ...
    return multi_soft_dice_loss(y_pred, y_true, num_classes, smooth, reduction)
